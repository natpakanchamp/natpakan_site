...
<img class="full-bleed" src="{{ '/assets/Omlong/omlong_2.jpeg' | relative_url }}" alt="amlong-cover">
...
<img src="{{ '/assets/Omlong/omlong_survey.jpeg' | relative_url }}" alt="amlong-cover">
...
<img src="{{ '/assets/Omlong/omlong_10.jpeg' | relative_url }}" width="100%" alt="amlong-cover">
...
เช้าวันที่ 20 ธันวาคม 2568 ราว 07:00 พวกเราจองรถตู้ออกเดินทางไปสำรวจโรงเรียน ถึงจุดเปลี่ยนรถด้านล่างราว 10:00 วันนั้นอากาศค่อนข้างอบอุ่น เราได้เจอกับ "ครูเล็ก" เป็นครั้งแรก ครูเป็นคนพาเราขึ้นไปสำรวจโรงเรียน นั่งท้ายกระบะกันไป 10 คน ตลอดทางยังเป็นถนนดินแดงเต็มไปด้วยฝุ่น แต่เริ่มเห็นร่องรอยว่ากำลังจะปูถนนกันแล้ว
  ...
  <video 
    ...
    muted
    >
    <source src="{{ '/assets/Omlong/omlong_video_1.mp4' | relative_url }}" type="video/mp4">
  </video>
...
<video
    ...
    muted
    >
    <source src="{{ '/assets/Omlong/omlong_video_2.mp4' | relative_url }}" type="video/mp4">
</video>
...
<img src="{{ '/assets/Omlong/omlong_1.jpg' | relative_url }}" alt="amlong-rice">
...
<img src="{{ '/assets/Omlong/omlong_8.jpeg' | relative_url }}" alt="amlong-rice">
...
<img src="{{ '/assets/Omlong/omlong_9.jpeg' | relative_url }}" alt="amlong-rice">
...
<img src="{{ '/assets/Omlong/omlong_7.jpeg' | relative_url }}" alt="amlong-rice">

## วันสุดท้าย — เด็กดอย แปลงผักขั้นบันได และกองไฟที่เกือบไม่ติด

<img src="{{ '/assets/Omlong/omlong_11.jpeg' | relative_url }}" alt="amlong-rice">
...
<img src="{{ '/assets/Omlong/omlong_6.jpeg' | relative_url }}" alt="amlong-rice">
...
<img src="{{ '/assets/Omlong/omlong_4.jpg' | relative_url }}" alt="amlong-fire">
...
<div class="slider full-bleed">
    <img src="{{ '/assets/Omlong/omlong_end.jpeg' | relative_url }}" alt="amlong-rice">
    <img src="{{ '/assets/Omlong/omlong_5.jpeg' | relative_url }}" alt="ค่ายอมลอง 1">
    <img src="{{ '/assets/Omlong/omlong_2.jpeg' | relative_url }}" alt="ค่ายอมลอง 2">
    <img src="{{ '/assets/Omlong/omlong_3.jpg' | relative_url }}" alt="ค่ายอมลอง 4">
    <img src="{{ '/assets/Omlong/omlong_survey.jpeg' | relative_url }}" alt="ค่ายอมลอง 5">
</div>