...
<img src="{{ '/assets/firstday-arsa.jpeg' | relative_url }}" alt="firstday-arsa">
...
<img src="{{ '/assets/renovate1.jpeg' | relative_url }}" alt="renovate1">

วันแรกๆก็ยังไม่ค่อยสนิทกับใครครับ เงียบซึมเลย แต่ผมก็พยายามช่วยงานเต็มที่ครับ

<img src="{{ '/assets/renovate2.jpeg' | relative_url }}" alt="renovate2">
...
<img src="{{ '/assets/mountain-arsa.jpg' | relative_url }}" alt="mountain-arsa">

หลังๆเริ่มสนิทกันแล้วครับ กลายเป็นไทยมุงทุกครั้งที่มีโอกาส

<img src="{{ '/assets/arsa-vibe1.jpeg' | relative_url }}" alt="arsa-vibe1">

<img src="{{ '/assets/arsa-vibe2.jpeg' | relative_url }}" alt="arsa-vibe2">

อาคารเริ่มเป็นรูปเป็นร่างแล้ว

<img src="{{ '/assets/building-arsa.jpg' | relative_url }}" alt="building-arsa">

มาถึงวันสุดท้ายแล้ว รู้สึกเวลาตอนอยู่บนค่ายเวลาผ่านไปไวมากเลย แป๊บๆก็วันสุดท้ายแล้ว ในวันนี้พวกเราจะต้องทำกิจกรรมกับน้องๆในโรงเรียน ซึ่งเป็นความรู้สึกอบอุ่นที่หาไม่ได้ที่ไหน ความรู้สึกแปลกๆนี้จึงเป็นความรู้สึกที่น่าประทับใจสำหรับผมครับ ทำให้เป็นจุดเริ่มต้นในการอยากนำความรู้ด้านสายอาชีพของผมมาอาสาทำสิ่งที่เกิดประโยชน์ในค่ายถัดไป หรือในอนาคตที่มีโอกาสครับ

<img src="{{ '/assets/arsa-vibe3.jpeg' | relative_url }}" alt="arsa-vibe3">

<img src="{{ '/assets/arsa-vibe4.jpeg' | relative_url }}" alt="arsa-vibe4">

<img src="{{ '/assets/arsa-vibe5.jpeg' | relative_url }}" alt="arsa-vibe5">

<img src="{{ '/assets/lastday-arsa.jpg' | relative_url }}" alt="lastday-arsa">