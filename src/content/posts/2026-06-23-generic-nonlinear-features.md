...
> Note นี้ขยายหัวข้อ **generic non-linear features** จากบทความ [Deep Learning (LeCun, Bengio & Hinton — Nature 2015)](/notes/2026/06/23/deep-learning-notes/) โดยเฉพาะส่วนที่กล่าวถึงข้อจำกัดของ [linear classifier](#) และทางออกก่อนที่ deep learning จะเข้ามาแก้ปัญหา
...
[**Linear classifier**](/notes/2026/06/23/deep-learning-notes/) แบ่งปริภูมิอินพุตได้เพียง **ครึ่งปริภูมิ (half-spaces)** ที่คั่นด้วย **ไฮเปอร์เพลน (hyperplane)** ซึ่งไม่เพียงพอสำหรับข้อมูลในโลกจริง
...
ปัญหานี้เรียกว่า [**selectivity–invariance dilemma**](/notes/2026/06/23/deep-learning-notes/) จาก DL note: ต้องการ classifier ที่ **ไวต่อความแตกต่างสำคัญ** แต่ **ทนทานต่อความแปรผันที่ไม่เกี่ยวข้อง** พร้อมกัน — สิ่งที่ linear classifier ไม่สามารถทำได้
...
| **Learned features (deep learning)** | เครื่องเรียนรู้ [feature extractor](/notes/2026/06/23/deep-learning-notes/) โดยอัตโนมัติจากข้อมูล |
...
<div class="exam-box">
  ...
  ตามที่ระบุใน <a href="/notes/2026/06/23/deep-learning-notes/">DL note (LeCun et al. 2015)</a>:<br><br>
  <blockquote>
...
แทนที่จะใช้ generic feature mapping φ ที่ไม่รู้จักข้อมูล deep learning เรียนรู้ **ลำดับชั้นของ non-linear transformations** จากข้อมูลโดยตรง ผ่าน [backpropagation](/notes/2026/06/23/deep-learning-notes/):
...
[**ReLU**](/notes/2026/06/23/deep-learning-notes/) `f(z) = max(0, z)` เป็น activation function ที่นิยมที่สุด เพราะ:
- คำนวณเร็ว
...
|---|---|---|
| **Linear classifier** | สิ่งที่ต้องการใช้ในปริภูมิใหม่ | [อ่านเพิ่มเติม](/notes/2026/06/23/deep-learning-notes/) |
| **Hyperplane** | ขอบเขตการตัดสินใจใน feature space | [อ่านเพิ่มเติม](/notes/2026/06/23/deep-learning-notes/) |
| **Feature extractor** | φ(x) ใน kernel method / ชั้น neural network | [อ่านเพิ่มเติม](/notes/2026/06/23/deep-learning-notes/) |
| **Representation learning** | deep learning เรียนรู้ φ อัตโนมัติ | [อ่านเพิ่มเติม](/notes/2026/06/23/deep-learning-notes/) |
| **ReLU** | non-linear activation ที่ทำให้ deep network ฝึกได้ | [อ่านเพิ่มเติม](/notes/2026/06/23/deep-learning-notes/) |
| **Backpropagation** | วิธีเรียนรู้พารามิเตอร์ของ non-linear layers | [อ่านเพิ่มเติม](/notes/2026/06/23/deep-learning-notes/) |
| **Selectivity–Invariance** | ปัญหาที่ generic features ยังแก้ไม่สมบูรณ์ | [อ่านเพิ่มเติม](/notes/2026/06/23/deep-learning-notes/) |
